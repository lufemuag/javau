...
public class ClientDAO {
    ...
    public List<Client> getAllClients() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                client.setCreatedAt(cursor.getString(cursor.getColumnIndexOrThrow(DatabaseHelper.COLUMN_CLIENT_CREATED_AT)));
    ...
    public List<Client> searchClients(String searchTerm) {
        ...
        String query = "SELECT * FROM " + DatabaseHelper.TABLE_CLIENTS + 
                      ...
                      DatabaseHelper.COLUMN_CLIENT_CEDULA + " LIKE ?" +
                      " ORDER BY " + DatabaseHelper.COLUMN_CLIENT_CREATED_AT + " DESC";
    ...
    public boolean isClientExists(String cedula) {
        SQLiteDatabase db = dbHelper.getReadableDatabase();
        String query = "SELECT 1 FROM " + DatabaseHelper.TABLE_CLIENTS + 
                      " WHERE " + DatabaseHelper.COLUMN_CLIENT_CEDULA + " = ?";
        
        Cursor cursor = db.rawQuery(query, new String[]{cedula});
