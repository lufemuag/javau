...
public class ProductDAO {
    ...
    public List<Product> getAllProducts() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                product.setCreatedAt(cursor.getString(cursor.getColumnIndexOrThrow(DatabaseHelper.COLUMN_PRODUCT_CREATED_AT)));
    ...
    public List<Product> searchProducts(String searchTerm, String categoria) {
        List<Product> products = new ArrayList<>();
        SQLiteDatabase db = dbHelper.getReadableDatabase();
        
        StringBuilder queryBuilder = new StringBuilder();
        queryBuilder.append("SELECT * FROM ").append(DatabaseHelper.TABLE_PRODUCTS);
        
        List<String> whereConditions = new ArrayList<>();
        List<String> selectionArgs = new ArrayList<>();
        
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            whereConditions.add("(" + DatabaseHelper.COLUMN_PRODUCT_DESCRIPCION + " LIKE ? OR " +
                               DatabaseHelper.COLUMN_PRODUCT_CODIGO + " LIKE ?)");
        ...
        if (categoria != null && !categoria.trim().isEmpty()) {
            whereConditions.add(DatabaseHelper.COLUMN_PRODUCT_CATEGORIA + " = ?");
        ...
        queryBuilder.append(" ORDER BY ").append(DatabaseHelper.COLUMN_PRODUCT_CREATED_AT).append(" DESC");
