...
public class InvoiceDAO {
    ...
    public List<Invoice> getAllInvoices() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                invoice.setCreatedAt(cursor.getString(cursor.getColumnIndexOrThrow(DatabaseHelper.COLUMN_INVOICE_CREATED_AT)));
                
                // Datos relacionados
                invoice.setClienteNombre(cursor.getString(cursor.getColumnIndexOrThrow("cliente_nombre")));
    ...
    public double getTotalRevenue() {
        ...
        String query = "SELECT SUM(" + DatabaseHelper.COLUMN_INVOICE_TOTAL + ") FROM " + 
                      DatabaseHelper.TABLE_INVOICES + 
                      " WHERE " + DatabaseHelper.COLUMN_INVOICE_ESTADO + " = 'pagada'";
        Cursor cursor = db.rawQuery(query, null);
